...
const Testimonials = () => {
  return (
    <section className="bg-lightPeach/10 px-4 sm:px-6 md:px-10 ">
      <h2 className="text-center text-3xl sm:text-4xl md:text-5xl xl:text-6xl py-12 text-primaryGreen font-bold  tracking-wider">Testimonials</h2>
